...
function SidebarProvider({
  ...
  const toggleSidebar = React.useCallback(() => {
    return isMobile && !ignoreMobile ? setOpenMobile(open => !open) : setOpen(open => !open);
  }, [isMobile, ignoreMobile, setOpen, setOpenMobile]);
  ...
  const contextValue = React.useMemo<SidebarContextProps>(
    ...
    [state, open, setOpen, isMobile, ignoreMobile, openMobile, setOpenMobile, toggleSidebar]
  );
...
function Sidebar({
  ...
  const { isMobile, ignoreMobile, state, openMobile, setOpenMobile } = useSidebar();
  ...
  return (
    <div
      className={cn(
        ...
        ignoreMobile ? 'block' : 'hidden md:block'
      )}
      data-state={state}
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          ignoreMobile ? 'flex' : 'hidden md:flex',
          side === 'left'
